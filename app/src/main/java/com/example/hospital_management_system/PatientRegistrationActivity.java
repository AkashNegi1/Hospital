...
// Create a reference to "mountains.jpg"
        ...
        mountainsRef.putFile(resultUri).addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(PatientRegistrationActivity.this, "Failed to Upload Image", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(PatientRegistrationActivity.this, "Successfully Uploaded Image", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String downloadUri = downloadUrl;
                        ...
                        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                 ...
                                 if(task.isSuccessful()){
                                    ...
                                    userInfo.put("ImgUri",downloadUrl);
